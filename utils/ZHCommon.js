  ...
  if (that.deBugLog){
    ...
    switch(level){
      case that.ZH_Log_Level.ZH_Log_Info:
        remindString = "✅Debug"
        break;
      case that.ZH_Log_Level.ZH_Log_Error:
        remindString = "❗️Error"
        break;
      case that.ZH_Log_Level.ZH_Log_Warning:
        remindString = "❓Warning"
        break;
      case that.ZH_Log_Level.ZH_Log_Verblose:
        remindString = "🔤 Verbose"
        break;

    }
    console.log(preString, remindString, info)
  }

}


function printLogWithBuffer(arrayBuffer, label){
  ...
  if(this.deBugLog){
    ...
    this.printDebugInfo(result, this.ZH_Log_Level.ZH_Log_Debug)
...
module.exports = {
  ...
  getCRC16WithValue: getCRC16WithValue,
  printLogWithBuffer: printLogWithBuffer
}